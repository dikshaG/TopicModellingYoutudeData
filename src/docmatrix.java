...
/**
 * Class performing all operations of tfidf.
 * 
 */
...
public class docmatrix {
	...
	void printGenderTopics() {
		...
		System.out.println("==================================MALE TOPICS=======  Total males: "+ maleTopics.size() + " Total male topics:" + maleSet.size() );
		System.out.println(maleTopics);
		System.out
				.println("==================================FEMALE TOPICS======= Total females: "+ femaleTopics.size() + " Total female topics:" + femaleSet.size());
